...
var KeycloakHttp = (function (_super) {
    ...
    KeycloakHttp.prototype.configureRequest = function (url, count, options) {
        ...
        if (options.withCredentials && !KeycloakHttp.readyBehaviourSubject.getValue()) {
            ...
            return KeycloakHttp.readyObs.take(2).filter(function (ready) { return ready === true; }).flatMap(function (ready) {
...
KeycloakHttp.readyObs = KeycloakHttp.readyBehaviourSubject.asObservable();
...
KeycloakHttp.ctorParameters = function () { return [
    ...
    { type: keycloak_auth_service_1.KeycloakAuthorization, },
]; };
